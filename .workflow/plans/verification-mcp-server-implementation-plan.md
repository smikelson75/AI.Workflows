...
- **Next slice:** [Slice 01 - Package toolchain and verify gate](phases/phase-05/slice-01-package-toolchain.md)
...
| # | Slice | Status | Detail |
|---|-------|--------|--------|
| 01 | Package toolchain and verify gate | planned | [detail](phases/phase-05/slice-01-package-toolchain.md) |
| 02 | Repository root resolution and fail-closed error contract | planned | [detail](phases/phase-05/slice-02-repo-root-and-errors.md) |
