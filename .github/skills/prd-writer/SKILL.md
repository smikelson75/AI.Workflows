...
Defaults: read `CONTEXT.md`, `UBIQUITOUS-LANGUAGE.md` if present, and write `docs/prd/scheduler-prd.md`.
...
3. existing `docs/prd/scheduler-prd.md`, if present
...
5. Write/update `docs/prd/scheduler-prd.md` using [references/PRD-FORMAT.md](references/PRD-FORMAT.md).
