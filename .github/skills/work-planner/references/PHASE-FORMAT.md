...
- the last slice in the list is always the integration and/or end-to-end slice for the phase (with mutation testing wired into its verification command where supported; mutation testing is not an independent slice)
