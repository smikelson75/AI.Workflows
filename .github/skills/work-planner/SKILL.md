...
- Do not name a test framework, assertion library, or mocking library in a slice. State the verification command the repository actually uses; the test stack is discovered by [`tdd`](../tdd/SKILL.md), not prescribed here.
