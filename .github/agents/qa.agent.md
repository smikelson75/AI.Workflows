...
You may edit only `docs/plans/phases/phase-XX/acceptance.feature` for the selected phase. You do not implement or execute tests, edit requirements or plans, record approval, or dispatch `Engineer`.
